...
public class map_Ui_Manager : MonoBehaviour
{
    ...
    {        
        ...
        Debug.Log("ui Gm.floor : " + GameManager.instance._CurMap.floor);

        GetComponent<MapDrowing>().MapDrow();

        //Map_IMG.GetComponent<RectTransform>().anchoredPosition += GameManager.instance.floor * new Vector2(0,-200);
